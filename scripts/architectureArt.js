...
<section class="project" id="project-panam">
				<div class="wrapper-arch-art">
				...
				<div class="project-description">
					...
					<div class="project-description__wrapper">
						...
						<h3><span>사이즈</span> : ${projects[artProjectIndex].size}</h3>
						<h3><span>사용한 자재</span> : ${projects[artProjectIndex].materials}</h3>
